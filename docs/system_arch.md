...
- **[Frontend](https://github.com/metersphere/metersphere)**: 测试管理平台 的前端工程, 基于 Vue.js 进行开发
- **[Backend](https://github.com/metersphere/metersphere)**: 测试管理平台 的后端工程, 基于 Spring Boot 进行开发, 为 测试管理平台 的功能主体
- **[Chrome plugin](https://github.com/metersphere/chrome-extensions)**: 浏览器插件, 录制 Web 访问请求生成 JMeter 脚本并导入到 测试管理平台 中用于接口测试及能测试
- **[Node controller](https://github.com/metersphere/node-controller)**: 为性能测试提供独立节点类型的测试资源池, 接收来自系统的性能测试任务, 动态的启动 JMeter容器完成性能测试
- **MySQL**: 测试管理平台 项目的主要数据均存储在 MySQL
...
- **组织**: 测试管理平台 中的一级租户, 可映射为一个公司下的不同部门
